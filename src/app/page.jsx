...
export default function Home() {
  const produkHosting = [
    ...
    },
    {
      ...
      fitur: ["20 GB SSD", "Unmetered Bandwidth", "Node.js, Python & Ruby", "Database Manager", "Terminal Akses", "Git Integration"],
          ...
          {produkHosting.map((produk) => (
            <div key={produk.id} className="bg-white rounded-xl shadow-xl overflow-hidden transition-transform duration-300 hover:scale-[1.02] border border-gray-100">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">{produk.deskripsi}</p>
                <div className="mb-4">
                  <span className="text-2xl font-bold text-blue-600">{produk.harga}</span>
                  {produk.id === 1 && (
                    <span className="ml-2 text-sm text-gray-500 line-through">Rp 199.000</span>
                  )}
                </div>
